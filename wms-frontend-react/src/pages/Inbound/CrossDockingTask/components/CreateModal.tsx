...
import { createCrossDockingTask } from '../services/crossDockingTaskApi'
...
const CrossDockingTaskCreateModal:React.FC<Props> = ({isCreateOpen,handleCloseModal}) => {
   ...
   const handleChange = (field: string) => (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
    ...
    const handleSubmit = async () => {
      setIsLoading(true)
      const complete = await dispatch(createCrossDockingTask(formData))
      setIsLoading(complete?.status)
      if(complete?.error == null){
        handleCloseModal()
        showToast(
          '',
          'Create CrossDocking Task Successfully',
          'top-right',
          'success'
        )
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <Input
                type="text"
                value={formData.cross_docking_task_code}
...
export default CrossDockingTaskCreateModal